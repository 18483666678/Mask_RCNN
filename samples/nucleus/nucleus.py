...
# Directory to save logs001 and model checkpoints, if not provided
# through the command line argument --logs001
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs001")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs001', required=False,
                        default=DEFAULT_LOGS_DIR,
                        metavar="/path/to/logs001/",
                        help='Logs and checkpoints directory (default=logs001/)')
